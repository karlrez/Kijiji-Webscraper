...
public class CreateAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //from parameter map.
            out.printf("<input type=\"text\" name=\"%s\" value=\"\" maxlength='45' required><br>",AccountLogic.DISPLAY_NAME);
            out.println("<br>");
            out.println("User:<br>");
            out.printf("<input type=\"text\" name=\"%s\" value=\"\" maxlength='45' required><br>",AccountLogic.USER);
            out.println("<br>");
            out.println("Password:<br>");
            out.printf("<input type=\"password\" name=\"%s\" value=\"\" maxlength='45' required><br>",AccountLogic.PASSWORD);
            out.println("<br>");
