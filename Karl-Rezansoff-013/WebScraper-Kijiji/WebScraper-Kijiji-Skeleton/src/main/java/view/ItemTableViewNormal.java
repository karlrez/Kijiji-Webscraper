...
public class ItemTableViewNormal extends HttpServlet {
    ...
    Item aItem = new Item();
    List<Item> entityList = logic.getAll();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet ItemTableViewNormal</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            entityList.forEach((entity) -> {
                out.printf("<tr><td>%d</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>",
